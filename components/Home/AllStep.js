    ...
    <div className={`my-32 lg:px-32 container mx-auto`}>
      <div className="lg:grid grid-cols-4 gap-10 items-center ">
       <div>
        ...
        <Image src={step1} alt='img' />
        </div>
         <div className='text-center'>
          <p><span  className=' bg-offOrange px-2 py-1 rounded-full'>step 1</span></p>
       ...
       <div>
        <div className='w-[140px] h-[140px]  mx-auto mb-3'>
        <Image src={step2} alt='img' />
        </div>
         <div className='text-center'>
          <p><span  className=' bg-offBlue px-2 py-1 rounded-full'>step 2</span></p>
       ...
       <div>
        <div className='w-[140px] h-[140px]  mx-auto mb-3'>
        <Image src={step3} alt='img' />
        </div>
         <div className='text-center'>
          <p><span  className=' bg-secondary px-2 py-1 rounded-full'>step 3</span></p>
       ...
       <div>
        <div className='w-[140px] h-[140px]  mx-auto mb-3'>
        <Image src={step4} alt='img' />
        </div>
         <div className='text-center'>
          <p><span  className=' bg-violet px-2 py-1 rounded-full'>step 4</span></p>
