      ...
      <div className="lg:grid grid-cols-3 gap-10 lg:p-0 p-5 cursor-pointer">
        <div>
          <div className="rounded-2xl bg-[#F3F4F6]">
            <Image src={ex1} alt="img" />
          </div>
          <div className="grid grid-cols-3 py-3 gap-3">
            <Image src={ex2} alt="img" />
            <Image src={ex3} alt="img" />
            <Image src={ex4} alt="img" />
          </div>
        ...
        <div>
          <div className="rounded-2xl bg-[#F3F4F6]">
            <Image src={ex5} alt="img" />
          </div>
          <div className="grid grid-cols-3 py-3 gap-3">
            <Image src={ex6} alt="img" />
            <Image src={ex7} alt="img" />
            <Image src={ex8} alt="img" />
          </div>
          <div className="my-2 flex justify-between items-center">
            <div>
        ...
        <div>
          <div className="rounded-2xl bg-[#F3F4F6]">
            <Image src={ex9} alt="img" />
          </div>
          <div className="grid grid-cols-3 py-3 gap-3">
            <Image src={ex10} alt="img" />
            <Image src={ex11} alt="img" />
            <Image src={ex12} alt="img" />
          </div>
          <div className="my-2 flex justify-between items-center">
            <div>
